    ...
    try {
        ...
        function finalizeUpload() {
            ...
            if (isGRN) {
                ...
                filteredRows = rawRows.filter(row => {
                    const eventType = String(getRowValue(row, 'Trans./Event Type') || getRowValue(row, 'Document Type') || '').trim().toUpperCase();
                    return eventType === 'WL';
                });
            }
